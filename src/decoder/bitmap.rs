...
mod tests {
    ...
    fn next_ends_with_one() {
        ...
        let block_header = BlockHeader { num_records: 0, placeholder1: 0, block_len: 0, flags_len: 0, placeholder4: 0, placeholder2: 0, placeholder3: 0, bitmap_type: 0, metadata_compression: 0 };
