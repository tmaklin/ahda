...
fn main() {
    ...
    match &cli.command {
        ...
        Some(cli::Commands::Set {
            ...
            let block_header = BlockHeader{ num_records: header_a.n_queries, bitmap_type: 0, metadata_compression: 0, block_len: 0, flags_len: 0, placeholder4: 0, placeholder1: 0, placeholder2: 0, placeholder3: 0 };
