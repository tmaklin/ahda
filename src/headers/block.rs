...
pub struct BlockHeader {
    ...
    /// Index of the first query stored in this block
    pub start_idx: u32,
...
mod tests {
    ...
    fn encode_block_header() {
        ...
        let data = BlockHeader{ num_records: 31, placeholder1: 257, block_len: 65511, flags_len: 921, start_idx: 0, placeholder2: 0, placeholder3: 0 };
    ...
    fn decode_block_header() {
        ...
        let expected = BlockHeader{ num_records: 31, placeholder1: 257, block_len: 65511, flags_len: 921, start_idx: 0, placeholder2: 0, placeholder3: 0 };
    ...
    fn read_block_flags() {
        ...
        let header = BlockHeader{ num_records: 31, placeholder1: 257, block_len: 65511, flags_len: data_bytes.len() as u32, start_idx: 0, placeholder2: 0, placeholder3: 0 };
        let mut data: Cursor<Vec<u8>> = Cursor::new(data_bytes);
    ...
    fn read_block_header_and_flags() {
        ...
        let expected_header = BlockHeader{ num_records: 31, placeholder1: 257, block_len: 65511, flags_len: 31 as u32, start_idx: 0, placeholder2: 0, placeholder3: 0 };
